...
enum SwinsianShuffleType {
	SwinsianShuffleTypeTrackShuffle = 'SWts',
	SwinsianShuffleTypeAlbumShuffle = 'SWas',
	SwinsianShuffleTypeNone = 'SWsn'
};
typedef enum SwinsianShuffleType SwinsianShuffleType;
...
@property BOOL repeatQueue;  // repeat playback
@property BOOL repeatSingle;  // repeat single track
@property BOOL stopAfterEveryTrack;  // stop playback at the end of every track
@property BOOL stopAfterTrack;  // stop after the current track
@property (copy, readonly) SwinsianLibrary *musicLibrary;  // the music library
@property SwinsianShuffleType shuffle;  // shuffle mode
...
@property (copy) NSString *sortArtist;  // the sort artist
@property (copy) NSString *sortAlbum;  // the sort album
@property (copy) NSString *sortAlbumArtist;  // the sort album artist
@property (copy) NSNumber *bpm;  // the bpm
@property (copy) NSString *barcode;  // the barcode
